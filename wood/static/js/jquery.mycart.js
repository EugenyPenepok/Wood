        ...
        var drawTable = function () {
            ...
            $.each(products, function () {
                ...
                $cartTable.append(
                    ...
                    '<td title="Remove from Cart" class="text-center"><a href="javascript:void(0);" class="btn btn-xs btn-danger ' + classProductRemove + '">X</a></td>' +
                    '</tr>'
                );
            });
            ...
            // '<tr style="color: red">' +
            // '<td></td>' +
            // '<td><strong>Итого (включая скидку)</strong></td>' +
            // '<td></td>' +
            // '<td></td>' +
